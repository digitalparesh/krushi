      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav">
          <li class="nav-item px-2">
            <a href="<?php echo url('index.php')?>" class="nav-link <?php if($active=='dashboard') echo "active" ?>">Dashboard</a>
          </li>
          <li class="nav-item px-2">
            <a href="<?php echo url('contact.php')?>" class="nav-link <?php if($active=='contact') echo "active" ?>">Contact</a>
          </li>
				</ul>
