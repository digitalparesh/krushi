    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 m-auto text-center">
          <h1>Our Services</h1>
          <p>We Specialize in Creating Great Quality Website design, software, web application, video editing.</p>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="card-deck card-columns">
        <div class="card shadow-lg">
          <div class="card-header bg-info text-center">Web Design</div>
          <img class="card-img-top" src="img/design.jpg" alt="Card image" style="width:100%">
          <div class="card-body bg-light">
            <p class="card-text text-justify">need to re-design your old website?? Responsive SEO Friendly website
              make in cheap
              price.We Create Unique & Custom Website Design As per customer requirement.</p>
          </div>
        </div>
        <div class="card shadow-lg">
          <div class="card-header bg-info text-center">Web Development</div>
          <img class="card-img-top" src="img/development.png" alt="Card image" style="width:100%">
          <div class="card-body">
            <p class="card-text">Web Development is necessary when the world is moving rapidly and number of internet
              devices is growing. We make it easy by understanding your requirements.</p>
          </div>
        </div>
        <div class="card shadow-lg">
          <div class="card-header bg-info text-center">Video Editing</div>
          <img class="card-img-top" src="img/video-editing.png" alt="Card image" style="width:100%">
          <div class="card-body">
            <p class="card-text text-justify">We use software like Adobe Premiere, Avid, Final Cut Pro, Edius Pro, and
              other video
              editing software in the most effective way to deliver transformative results.</p>
          </div>
        </div>
      </div>
          ...
          <div id="accordion">
            <div class="card">
              <div class="card-header">
                <h5 class="mb-0">
                  <a href="#collapseOne" data-toggle="collapse" data-parent="accordion">
                    How Much Money need to design a small website?
                  </a>
                </h5>
              </div>
              ...
              <div id="collapseOne" class="collapse">
                <div class="card-body">
                  This is depend in your website functionality if you want more information please call now : 6354315536
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="mb-0">
                  <a href="#collapseTwo" data-toggle="collapse" data-parent="accordion">
                    Does Time Space Hire JavaScript Developer?
                  </a>
                </h5>
              </div>
              ...
              <div id="collapseTwo" class="collapse">
                <div class="card-body">
                  Yes We hire JavaScript Developer.
                </div>
              </div>
            </div>
              ...
              <div class="card-header">
                <h5 class="mb-0">
                  <a href="#collapseThree" data-toggle="collapse" data-parent="accordion">
                    What is your web design and development process? </a>
                </h5>
              </div>

              <div id="collapseThree" class="collapse">
                <div class="card-body">
                  Our Web design process is to easy. we just ask your requirement and then create it simple :).
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="accordion">
            <div class="card">
              ...
              <div id="collapseFour" class="collapse">
                <div class="card-body">
                  We provide all solution that you want.
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div id="collapseFive" class="collapse">
                <div class="card-body">
                  We recommend wordpress because is seo friendly.
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div id="collapseSix" class="collapse">
                <div class="card-body">
                  It's depend on project functionality.
                </div>
              </div>
            </div>
          </div>
